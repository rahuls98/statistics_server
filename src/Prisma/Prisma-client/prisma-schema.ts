// Code generated by Prisma (prisma@1.28.3). DO NOT EDIT.
  ...
  export const typeDefs = /* GraphQL */ `enum ActivityType {
    COMMENT
    STATUS_CHANGE
  }
  ...
  type Mutation {
    ...
    createpauseActivity(data: pauseActivityCreateInput!): pauseActivity!
    updatepauseActivity(data: pauseActivityUpdateInput!, where: pauseActivityWhereUniqueInput!): pauseActivity
    updateManypauseActivities(data: pauseActivityUpdateManyMutationInput!, where: pauseActivityWhereInput): BatchPayload!
    upsertpauseActivity(where: pauseActivityWhereUniqueInput!, create: pauseActivityCreateInput!, update: pauseActivityUpdateInput!): pauseActivity!
    deletepauseActivity(where: pauseActivityWhereUniqueInput!): pauseActivity
    deleteManypauseActivities(where: pauseActivityWhereInput): BatchPayload!
  }
  ...
  type pauseActivityConnection {
    pageInfo: PageInfo!
    edges: [pauseActivityEdge]!
    aggregate: AggregatepauseActivity!
  }
  
  input pauseActivityCreateInput {
    pauseStart: DateTime
    pauseEnd: DateTime
  }
  
  input pauseActivityCreateManyInput {
    create: [pauseActivityCreateInput!]
    connect: [pauseActivityWhereUniqueInput!]
  }
  
  type pauseActivityEdge {
    node: pauseActivity!
    cursor: String!
  }
  
  enum pauseActivityOrderByInput {
    id_ASC
    id_DESC
    pauseStart_ASC
    pauseStart_DESC
  ...
  type pauseActivityPreviousValues {
    id: ID!
    pauseStart: DateTime
    pauseEnd: DateTime
  }
  
  input pauseActivityScalarWhereInput {
    id: ID
    id_not: ID
    id_in: [ID!]
    id_not_in: [ID!]
    ...
    id_not_ends_with: ID
    pauseStart: DateTime
    pauseStart_not: DateTime
    pauseStart_in: [DateTime!]
    pauseStart_not_in: [DateTime!]
    pauseStart_lt: DateTime
    pauseStart_lte: DateTime
    pauseStart_gt: DateTime
    pauseStart_gte: DateTime
    pauseEnd: DateTime
    pauseEnd_not: DateTime
    pauseEnd_in: [DateTime!]
    pauseEnd_not_in: [DateTime!]
    pauseEnd_lt: DateTime
    pauseEnd_lte: DateTime
    pauseEnd_gt: DateTime
    pauseEnd_gte: DateTime
    AND: [pauseActivityScalarWhereInput!]
    OR: [pauseActivityScalarWhereInput!]
    NOT: [pauseActivityScalarWhereInput!]
  }
  
  type pauseActivitySubscriptionPayload {
    mutation: MutationType!
    node: pauseActivity
    updatedFields: [String!]
  ...
  input pauseActivitySubscriptionWhereInput {
    mutation_in: [MutationType!]
    updatedFields_contains: String
    updatedFields_contains_every: [String!]
    updatedFields_contains_some: [String!]
    node: pauseActivityWhereInput
    AND: [pauseActivitySubscriptionWhereInput!]
    OR: [pauseActivitySubscriptionWhereInput!]
    NOT: [pauseActivitySubscriptionWhereInput!]
  }
  
  input pauseActivityUpdateDataInput {
    pauseStart: DateTime
    pauseEnd: DateTime
  }
  
  input pauseActivityUpdateInput {
    pauseStart: DateTime
    pauseEnd: DateTime
  }
  
  input pauseActivityUpdateManyDataInput {
    pauseStart: DateTime
    pauseEnd: DateTime
  }
  
  input pauseActivityUpdateManyInput {
    create: [pauseActivityCreateInput!]
    update: [pauseActivityUpdateWithWhereUniqueNestedInput!]
    upsert: [pauseActivityUpsertWithWhereUniqueNestedInput!]
    delete: [pauseActivityWhereUniqueInput!]
    connect: [pauseActivityWhereUniqueInput!]
    set: [pauseActivityWhereUniqueInput!]
    disconnect: [pauseActivityWhereUniqueInput!]
    deleteMany: [pauseActivityScalarWhereInput!]
    updateMany: [pauseActivityUpdateManyWithWhereNestedInput!]
  }
  
  input pauseActivityUpdateManyMutationInput {
    pauseStart: DateTime
    pauseEnd: DateTime
  }
  
  input pauseActivityUpdateManyWithWhereNestedInput {
    where: pauseActivityScalarWhereInput!
    data: pauseActivityUpdateManyDataInput!
  }
  
  input pauseActivityUpdateWithWhereUniqueNestedInput {
    where: pauseActivityWhereUniqueInput!
    data: pauseActivityUpdateDataInput!
  }
  
  input pauseActivityUpsertWithWhereUniqueNestedInput {
    where: pauseActivityWhereUniqueInput!
    update: pauseActivityUpdateDataInput!
    create: pauseActivityCreateInput!
  }
  
  input pauseActivityWhereInput {
    id: ID
    id_not: ID
    id_in: [ID!]
    id_not_in: [ID!]
    ...
    pauseEnd_gt: DateTime
    pauseEnd_gte: DateTime
    AND: [pauseActivityWhereInput!]
    OR: [pauseActivityWhereInput!]
    NOT: [pauseActivityWhereInput!]
  }
  
  input pauseActivityWhereUniqueInput {
    id: ID
  }
  ...
  type Query {
    ...
    pauseActivity(where: pauseActivityWhereUniqueInput!): pauseActivity
    pauseActivities(where: pauseActivityWhereInput, orderBy: pauseActivityOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [pauseActivity]!
    pauseActivitiesConnection(where: pauseActivityWhereInput, orderBy: pauseActivityOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): pauseActivityConnection!
    node(id: ID!): Node
  }
  ...
  type Subscription {
    ...
    pauseActivity(where: pauseActivitySubscriptionWhereInput): pauseActivitySubscriptionPayload
  }
